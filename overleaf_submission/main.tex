...
% proof environment provided by amsthm (with automatic QED)
...
\begin{IEEEkeywords}
Recurrent Feedback, Medical Image Segmentation, Polyp Segmentation, Feedback Trap, Detached Soft-OR, Zero-Shot Cross-Center Generalization
\end{IEEEkeywords}
\end{abstract}
