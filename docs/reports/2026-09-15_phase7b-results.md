...
| **Gia tăng Dice & Ổn định hóa** | Dice trung bình 5 seeds tăng **+4.77 pp** (từ 0.2517 lên 0.2995, +19.0%). Phương sai giữa các seeds giảm **66.5%** ($\sigma = 0.0869 \to 0.0291$). | Triệt tiêu hoàn toàn hiện tượng sụp đổ biểu diễn (Seed 1337 ở M11 sụp xuống Dice 0.0928, trong khi M12 đạt 0.2779). |
...
| **E-Phase7B-2** | Multi-seed segmentation: M12 vượt trội M11 về Dice và FPR trên Kvasir-SEG Sessile | Seeds 7, 42, 99, 1337, 2024. Đánh giá online validation per epoch và final checkpoints | M12 Dice = 0.2995 (+4.77 pp), M12 FPR = 2.46% (-42.8% rel), Std giảm 66.5% | `results_phase7b/multi_seed_summary.json` |
