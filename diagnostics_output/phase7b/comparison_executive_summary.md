...
4. **Hiệu năng Phân đoạn (Dice Score):** Dice trung bình trên 5 seeds tăng mạnh từ **0.2517** lên **0.2995** (**+4.77pp**). Precision tăng từ **31.4%** lên **38.9%** (+7.5pp), trong khi Recall được duy trì ổn định.
